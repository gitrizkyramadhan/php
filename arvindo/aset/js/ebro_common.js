...
ebro_autocomplete = {
    init: function () {
        $('.main_search .typeahead').typeahead({
            name: 'ebro-countries',
            valueKey: 'name',
            prefetch: 'aset/js/lib/typeahead.js/example.json',
            template: [
...
ebro_styleSwitcher = {
    init: function () {
        ...
        $('#style_reset').click(function () {
            $('body').removeClass('pattern_1 pattern_2 pattern_3 pattern_4 pattern_5 pattern_6 pattern_7 pattern_8  pattern_9  pattern_10').addClass('pattern_1');

...
transitionEffect:s.none,transitionEffectSpeed:200,onStepChanging:function(a,b,d){return!0},onStepChanged:function(a,b,d){},onFinishing:function(a,b){return!0},onFinished:function(a,b){},labels:{current:"current step:",pagination:"Pagination",finish:"Finish",next:"Next",previous:"Kembali",loading:"Loading ..."}};f.fn.extend({_aria:function(a,b){return this.attr("aria-"+a,b)},_removeAria:function(a){return this.removeAttr("aria-"+a)},_enableAria:function(){return this.removeClass("disabled")._aria("disabled",

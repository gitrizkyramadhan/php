            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nomor Surat Pajak</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="" class="form-control" name="nomor_ijin" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                ...
                function sub(){
                            ...
                            request.done(function (response, textStatus, jqXHR){
                                alert(response);
                                //return false;
                                location.href="<?= site_url('mockups#pajak/getTable') ?>";
                                return false;
                            });
                    ...
                    function uploads(){
                        ...
                        request = $.ajax({
                                url: "<?= site_url('master/upload/pajak') ?>",
                                type: "post",
                                processData: false,
                                contentType: false,       
                                cache: false,          
                            ...
                            request.done(function (response, textStatus, jqXHR){
                                ...
                                if(response[0] == 'sukses'){
                                    $('#upload').html('<a href="<?= base_url('upload/pajak/') ?>/'+response[1]+'" target="_blank" style="color: #1ABB9C;"><b>Preview File Upload</b></a>\
                                    | <a onclick="hapus()"><b>Hapus</b></a>\
                                    ');
                                    $('#file_name').val("<?= base_url('upload/pajak/') ?>/"+response[1]);
                                }
                                alert(response[2]);
                                return false;
                            });

                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input name="keterangan" type="text" value="" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Beli</label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                                <input name="tgl_beli" type="date" class="form-control has-feedback-left" id="single_cal3" placeholder="Tanggal" aria-describedby="inputSuccess2Status3">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input name="watt" type="text"  value=""  class="form-control" placeholder="">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input name="nominal" type="text" value="" class="form-control" placeholder="">
                        </div>

...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="aset/css/newtable.css?=<?= date('YmdHis') ?>">
        <link rel="stylesheet" href="aset/css/newtable-Biru.css?=<?= date('YmdHis') ?>">
        ...
        <script>
            ...
            $(document).ready(function () {
                if (window.location.hash === '') {
                    window.location.hash = '#login/home';
                }
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-2 col-sm-1 right">
                            ...
                            <img src="<?= base_url() . 'aset/img/logos.png'?>" style="margin-top: 8px;" width="200">
                        </div>
                        <div class="col-xs-10 col-sm-6" style="margin-left:8% ;">

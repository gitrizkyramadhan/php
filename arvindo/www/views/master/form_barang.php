                    ...
                    <form id='barang' class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                          <input type="text" name="kode" value = "<?= $jml ?>" class="form-control" readonly>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Suplier</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <?= form_dropdown("kd_suplier", $result, '', 'id="suplier" class="form-control"'); ?>
                        </div>
                      </div>
					  <div class="form-group">
                    ...
                    function sub(){
                            ...
                            $('form').find('input, textarea, select').each(function(idx, elem){
                               if($(elem).val().length == 0 && $(elem).attr('name') != 'filename'){   
                                   ...
                                   //alert(name);                                
                                   if(name == 'nama'){
                                        msg.push('  - Nama Barang Harus Diisi\n');
                                    }else if(name == 'stok'){
                                        msg.push('  - Jumlah Stok Harus Dipilih\n');
                                    }else if(name == 'satuan'){
                                        msg.push('  - Satuan Barang Harus Diisi\n');
                                    }
                               }
                            });
                            //return false;
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/add/barang') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input name="kdlokasi" type="text" class="form-control" placeholder="" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Lokasi</label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input name="nama_lokasi" type="text" class="form-control" placeholder="" required="">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <textarea name="alamat_lokasi" class="form-control" rows="3" placeholder=""></textarea>
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Arah Pandang</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <textarea name="arah_pandang" class="form-control" rows="3" placeholder=""></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/add/lokasi') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

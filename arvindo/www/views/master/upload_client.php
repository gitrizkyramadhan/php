    ...
    <div class="x_content">
        ...
        <form id="prop" method="post" action="<?= site_url('master/uploadFile/client') ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
            ...
            <div class="form-group">
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12"><a href="<?= base_url(). 'template/client.xlsx' ; ?>" style="cursor:pointer !important;">Download Template .xls</a></label>
            </div>

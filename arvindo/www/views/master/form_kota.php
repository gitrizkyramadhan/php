            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input type="text" name="kodekota" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kota</label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input type="text" name="namakota" class="form-control" placeholder="">
                        </div>
                      </div>
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/add/kota') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

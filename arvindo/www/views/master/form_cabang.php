            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input type="text" name="nama_cabang" class="form-control" placeholder="">
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Alamat Cabang</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <textarea class="form-control" name="alamat_cabang"  rows="3" placeholder=""></textarea>
                        </div>
                      </div>
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/add/cabang') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form id='barang' class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                          <input type="text" name="kode" value = "<?= $suplier->kd_suplier ?>" class="form-control" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" name="nama" value="<?= $suplier->nama_suplier ?>" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <select name="status" class="form-control">
                            ...
                            <option value="0" <?= ($suplier->status == 0 ? 'selected' : '') ?>>Non-Active</option>
                          </select>
                        </div>
                      </div>
                      <!--
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/update/suplier') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

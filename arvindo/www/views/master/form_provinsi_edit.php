            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form id="prop" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" value="<?= $data->kdprovinsi ?>" readonly="" class="form-control" name="id" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Provinsi</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" value="<?= $data->nama_provinsi ?>" class="form-control" name="nama" placeholder="">
                        </div>
                      </div>
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/update/provinsi') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });

...
<div class="x_panel">
    ...
    <div class="x_content">
        <br>
        <form  id="prop" method="post" action="<?= site_url('master/uploadFile/lokasi') ?>" enctype="multipart/form-data" class="form-horizontal form-label-left" >
            ...
            <div class="form-group">
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12"><a href="<?= base_url(). 'template/lokasi.xlsx' ; ?>" style="cursor:pointer !important;">Download Template .xls</a></label>
            </div>

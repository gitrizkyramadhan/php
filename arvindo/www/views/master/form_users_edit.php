            ...
            <a href="<?= site_url() ?>">Form</a> <?= $title ?></h1>
                    ...
                    <form class="form-horizontal form-label-left">
					  ...
					  <input type="hidden" name="id" value="<?= $this->uri->segment(4) ?>" />
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" name="username" class="form-control" placeholder="" value="<?= $data->username ?>">
                        </div>
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <?= form_dropdown("cabang", $cabang, $data->id_cabang, 'id="suplier" class="form-control"'); ?>
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama User</label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input id="conf" type="text" name="nama_user" class="form-control" placeholder=""  onkeyup="cek();"  value="<?= $data->nama ?>">
                        </div>
                      </div>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input id="conf" type="text" name="email" class="form-control" placeholder=""  onkeyup="cek();"  value="<?= $data->email ?>">
                        </div>
                      </div>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Role</label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <?= form_dropdown("role", $role, $data->status, 'id="role" class="form-control"'); ?>
                        </div>
                      </div>
                ...
                <script>
                    function sub(){
                            ...
                            request = $.ajax({
                                url: "<?= site_url('master/action/update/users') ?>",
                                type: "post",
                                data: $('form').serialize()
                            });
